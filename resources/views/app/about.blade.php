...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{env('APP_CDN')}}/bg_1.jpg); ">
                <a style="background-image: url({{env('APP_CDN')}}/bg_1.jpg); " class="icon popup-vimeo d-flex justify-content-center align-items-center">
                    <!-- <span class="icon-play"></span> -->
                </a>
            </div>
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate1">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to {{$info->name}} an eCommerce website</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    <p>{{$info->name}}</p>
